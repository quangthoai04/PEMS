-- =====================================================================
-- SEED LOGIC FIX v8.2.1: fixed seed data only; CREATE TABLE/campus seed kept unchanged.
...
VALUES
  ...
  (@vr_hist_04, 'VR-HIST-004', @v_lee, @p_asean, 'Lee Joon Ho', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'lee.joonho@seoultech.example', 'ASEAN Future Skills Foundation - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Lee Joon Ho','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','lee.joonho@seoultech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 52 DAY), DATE_SUB(@seed_now, INTERVAL 51 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 50 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó host ghi nhận xác nhận hủy ngoài hệ thống từ khách.', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 50 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 52 DAY), @v_lee, @seed_now, NULL),
  ...
  (@vr_hist_09, 'VR-HIST-009', @v_kim, @p_seoul, 'Kim Min Seo', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'kim.minseo@seoultech.example', 'Seoul Future University - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Kim Min Seo','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','kim.minseo@seoultech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 92 DAY), DATE_SUB(@seed_now, INTERVAL 91 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 90 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó khách tự hủy trên hệ thống.', @v_kim, DATE_SUB(@seed_now, INTERVAL 90 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 92 DAY), @v_kim, @seed_now, NULL),
  ...
  (@vr_hist_14, 'VR-HIST-014', @v_smith, @p_green, 'Emily Smith', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'emily.smith@greentech.example', 'GreenTech Asia Pte. Ltd. - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Emily Smith','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','emily.smith@greentech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 132 DAY), DATE_SUB(@seed_now, INTERVAL 131 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 130 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó host ghi nhận xác nhận hủy ngoài hệ thống từ khách.', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 130 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 132 DAY), @v_smith, @seed_now, NULL),
  ...
  (@vr_hist_19, 'VR-HIST-019', @v_nguyen_no_dau, @p_ministry, 'Nguyen Van Nam', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'nguyen.van.nam@partner.example', 'Viện Phát triển Giáo dục Quốc tế - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Nguyen Van Nam','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','nguyen.van.nam@partner.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 172 DAY), DATE_SUB(@seed_now, INTERVAL 171 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 170 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó khách tự hủy trên hệ thống.', @v_nguyen_no_dau, DATE_SUB(@seed_now, INTERVAL 170 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 172 DAY), @v_nguyen_no_dau, @seed_now, NULL),
  ...
  (@vr_hist_24, 'VR-HIST-024', @v_lee, @p_asean, 'Lee Joon Ho', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'lee.joonho@seoultech.example', 'ASEAN Future Skills Foundation - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Lee Joon Ho','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','lee.joonho@seoultech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 212 DAY), DATE_SUB(@seed_now, INTERVAL 211 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 210 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó host ghi nhận xác nhận hủy ngoài hệ thống từ khách.', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 210 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 212 DAY), @v_lee, @seed_now, NULL),
  ...
  (@vr_hist_29, 'VR-HIST-029', @v_kim, @p_seoul, 'Kim Min Seo', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'kim.minseo@seoultech.example', 'Seoul Future University - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Kim Min Seo','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','kim.minseo@seoultech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 252 DAY), DATE_SUB(@seed_now, INTERVAL 251 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 250 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó khách tự hủy trên hệ thống.', @v_kim, DATE_SUB(@seed_now, INTERVAL 250 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 252 DAY), @v_kim, @seed_now, NULL),
  ...
  (@vr_hist_34, 'VR-HIST-034', @v_smith, @p_green, 'Emily Smith', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'emily.smith@greentech.example', 'GreenTech Asia Pte. Ltd. - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Emily Smith','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','emily.smith@greentech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 292 DAY), DATE_SUB(@seed_now, INTERVAL 291 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 290 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó host ghi nhận xác nhận hủy ngoài hệ thống từ khách.', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 290 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 292 DAY), @v_smith, @seed_now, NULL),
  ...
  (@vr_hist_39, 'VR-HIST-039', @v_nguyen_no_dau, @p_ministry, 'Nguyen Van Nam', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'nguyen.van.nam@partner.example', 'Viện Phát triển Giáo dục Quốc tế - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Nguyen Van Nam','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','nguyen.van.nam@partner.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 332 DAY), DATE_SUB(@seed_now, INTERVAL 331 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 330 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó khách tự hủy trên hệ thống.', @v_nguyen_no_dau, DATE_SUB(@seed_now, INTERVAL 330 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 332 DAY), @v_nguyen_no_dau, @seed_now, NULL),
  ...
  (@vr_hist_44, 'VR-HIST-044', @v_lee, @p_asean, 'Lee Joon Ho', 'Tổ chức đối tác quốc tế', 'Điều phối đoàn khách', '0900000000', 'lee.joonho@seoultech.example', 'ASEAN Future Skills Foundation - chuyến thăm campus CT', 'SINGLE_CAMPUS', 'Trao đổi hợp tác, tham quan campus và làm việc với các phòng ban.', 'Làm việc với IC Office, tham quan khu học tập, phòng lab và trao đổi hợp tác.', 3, JSON_ARRAY(JSON_OBJECT('full_name','Điều phối viên đoàn','role','Coordinator')), JSON_OBJECT('full_name','Lee Joon Ho','organization','Tổ chức đối tác quốc tế','phone','0900000000','email','lee.joonho@seoultech.example'), 'EN', NULL, 'Đoàn tự túc xe 16 chỗ.', 'Vui lòng hỗ trợ bảng chào mừng và phòng họp.', 'CANCELLED', DATE_SUB(@seed_now, INTERVAL 372 DAY), DATE_SUB(@seed_now, INTERVAL 371 DAY), @u_stafflead_ct, DATE_SUB(DATE_SUB(@seed_now, INTERVAL 370 DAY), INTERVAL 1 DAY), 'STAFF_LEADER', 'Đã duyệt trước đó; sau đó host ghi nhận xác nhận hủy ngoài hệ thống từ khách.', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 370 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 372 DAY), @v_lee, @seed_now, NULL);
...
VALUES
  (@vi_pending_approval_hcm, @vr_pending_approval_seed, @campus_hcm, 'VR-PA-001-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 2 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 2 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 17 DAY), @v_pending_approval_seed, @seed_now, @v_pending_approval_seed),
  ...
  (@vi_as_hn, @vr_approved_single_before, @campus_hn, 'VR-AS-003-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 14 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 14 DAY), INTERVAL 990 MINUTE), 'BEFORE_VISIT', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 29 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 29 DAY), @v_kim, @seed_now, @u_staff_hn),
  (@vi_am_hn, @vr_approved_multi_during, @campus_hn, 'VR-AM-004-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 990 MINUTE), 'DURING_VISIT', @u_staff_hn, @u_ho_ha, DATE_SUB(@seed_now, INTERVAL 15 DAY), 'TRANSFERRED', @u_stafflead_hn, DATE_ADD(DATE_SUB(@seed_now, INTERVAL 15 DAY), INTERVAL 1 HOUR), 'Staff Leader đã chuyển Host chính thức cho IC Staff phụ trách tiếp đoàn.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 15 DAY), @v_lee, @seed_now, @u_staff_hn),
  (@vi_am_hcm, @vr_approved_multi_during, @campus_hcm, 'VR-AM-004-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 990 MINUTE), 'ASSIGNED', @u_staff_hcm, @u_ho_ha, DATE_SUB(@seed_now, INTERVAL 15 DAY), 'TRANSFERRED', @u_stafflead_hcm, DATE_ADD(DATE_SUB(@seed_now, INTERVAL 15 DAY), INTERVAL 1 HOUR), 'Staff Leader đã chuyển Host chính thức cho IC Staff phụ trách tiếp đoàn.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 15 DAY), @v_lee, @seed_now, @u_stafflead_hcm),
  (@vi_rs_hcm, @vr_rejected_single, @campus_hcm, 'VR-RS-005-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 5 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 5 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 20 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_rm_dn, @vr_rejected_multi, @campus_dn, 'VR-RM-006-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 20 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 20 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 35 DAY), @v_tanaka, @seed_now, @v_tanaka),
  (@vi_rm_ct, @vr_rejected_multi, @campus_ct, 'VR-RM-006-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 20 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 20 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 35 DAY), @v_tanaka, @seed_now, @v_tanaka),
  (@vi_cn_hn, @vr_cancelled, @campus_hn, 'VR-CN-007-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 30 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 30 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @v_nguyen_no_dau, DATE_SUB(@seed_now, INTERVAL 42 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 45 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  (@vi_av_ct, @vr_after_visit, @campus_ct, 'VR-AV-008-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -2 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -2 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_ct, @u_stafflead_ct, DATE_SUB(@seed_now, INTERVAL 22 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 22 DAY), @v_short_name, @seed_now, @u_staff_ct),
  (@vi_cl_hn, @vr_closed, @campus_hn, 'VR-CL-009-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -30 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -30 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 50 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -29 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 50 DAY), @v_long_name, @seed_now, @u_staff_hn),
  (@vi_ci_hcm, @vr_cancelled_instance, @campus_hcm, 'VR-CI-010-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 25 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 25 DAY), INTERVAL 990 MINUTE), 'BEFORE_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 2 DAY), 'TRANSFERRED', @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 2 DAY), 'Chuyển host cho IC Staff phụ trách GreenTech.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 40 DAY), @v_smith, @seed_now, @u_staff_hcm),
  (@vi_ci_hn, @vr_cancelled_instance, @campus_hn, 'VR-CI-010-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 25 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 25 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_hn, DATE_SUB(@seed_now, INTERVAL 4 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy campus instance sau khi khách xác nhận ngoài hệ thống rằng không tiếp tục lịch tại campus này.', 0, DATE_SUB(@seed_now, INTERVAL 40 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_ao_dn, @vr_assigned_only, @campus_dn, 'VR-AO-011-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 11 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 11 DAY), INTERVAL 990 MINUTE), 'ASSIGNED', @u_staff_dn, @u_stafflead_dn, DATE_SUB(@seed_now, INTERVAL 26 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 26 DAY), @v_lee, @seed_now, @u_stafflead_dn),
  (@vi_hist_01, @vr_hist_01, @campus_hn, 'VR-HIST-001-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -8 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -8 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 28 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -7 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 28 DAY), @v_kim, @seed_now, @u_staff_hn),
  (@vi_hist_02, @vr_hist_02, @campus_hcm, 'VR-HIST-002-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -16 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -16 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 36 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 36 DAY), @v_smith, @seed_now, @u_staff_hcm),
  (@vi_hist_03, @vr_hist_03, @campus_dn, 'VR-HIST-003-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -24 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -24 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 44 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  (@vi_hist_04, @vr_hist_04, @campus_ct, 'VR-HIST-004-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -32 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -32 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 50 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 52 DAY), @v_lee, @seed_now, @v_lee),
  (@vi_hist_05, @vr_hist_05, @campus_qn, 'VR-HIST-005-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -40 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -40 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 60 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_06, @vr_hist_06, @campus_hn, 'VR-HIST-006-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -48 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -48 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 68 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 68 DAY), @v_smith, @seed_now, @u_staff_hn),
  (@vi_hist_07, @vr_hist_07, @campus_hcm, 'VR-HIST-007-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -56 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -56 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 76 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hcm, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -55 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 76 DAY), @v_nguyen_no_dau, @seed_now, @u_staff_hcm),
  (@vi_hist_08, @vr_hist_08, @campus_dn, 'VR-HIST-008-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -64 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -64 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 84 DAY), @v_lee, @seed_now, @v_lee),
  (@vi_hist_09, @vr_hist_09, @campus_ct, 'VR-HIST-009-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -72 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -72 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @v_kim, DATE_SUB(@seed_now, INTERVAL 90 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 92 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_10, @vr_hist_10, @campus_qn, 'VR-HIST-010-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -80 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -80 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 100 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_11, @vr_hist_11, @campus_hn, 'VR-HIST-011-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -88 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -88 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 108 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -87 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 108 DAY), @v_nguyen_no_dau, @seed_now, @u_staff_hn),
  (@vi_hist_12, @vr_hist_12, @campus_hcm, 'VR-HIST-012-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -96 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -96 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 116 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 116 DAY), @v_lee, @seed_now, @u_staff_hcm),
  (@vi_hist_13, @vr_hist_13, @campus_dn, 'VR-HIST-013-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -104 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -104 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 124 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_14, @vr_hist_14, @campus_ct, 'VR-HIST-014-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -112 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -112 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 130 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 132 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_15, @vr_hist_15, @campus_qn, 'VR-HIST-015-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -120 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -120 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 140 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  (@vi_hist_16, @vr_hist_16, @campus_hn, 'VR-HIST-016-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -128 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -128 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 148 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 148 DAY), @v_lee, @seed_now, @u_staff_hn),
  (@vi_hist_17, @vr_hist_17, @campus_hcm, 'VR-HIST-017-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -136 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -136 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 156 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hcm, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -135 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 156 DAY), @v_kim, @seed_now, @u_staff_hcm),
  (@vi_hist_18, @vr_hist_18, @campus_dn, 'VR-HIST-018-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -144 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -144 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 164 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_19, @vr_hist_19, @campus_ct, 'VR-HIST-019-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -152 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -152 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @v_nguyen_no_dau, DATE_SUB(@seed_now, INTERVAL 170 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 172 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  (@vi_hist_20, @vr_hist_20, @campus_qn, 'VR-HIST-020-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -160 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -160 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 180 DAY), @v_lee, @seed_now, @v_lee),
  (@vi_hist_21, @vr_hist_21, @campus_hn, 'VR-HIST-021-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -168 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -168 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 188 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -167 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 188 DAY), @v_kim, @seed_now, @u_staff_hn),
  (@vi_hist_22, @vr_hist_22, @campus_hcm, 'VR-HIST-022-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -176 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -176 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 196 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 196 DAY), @v_smith, @seed_now, @u_staff_hcm),
  ...
  (@vi_hist_24, @vr_hist_24, @campus_ct, 'VR-HIST-024-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -192 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -192 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 210 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 212 DAY), @v_lee, @seed_now, @v_lee),
  (@vi_hist_25, @vr_hist_25, @campus_qn, 'VR-HIST-025-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -200 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -200 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 220 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_26, @vr_hist_26, @campus_hn, 'VR-HIST-026-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -208 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -208 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 228 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 228 DAY), @v_smith, @seed_now, @u_staff_hn),
  (@vi_hist_27, @vr_hist_27, @campus_hcm, 'VR-HIST-027-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -216 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -216 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 236 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hcm, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -215 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 236 DAY), @v_nguyen_no_dau, @seed_now, @u_staff_hcm),
  (@vi_hist_28, @vr_hist_28, @campus_dn, 'VR-HIST-028-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -224 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -224 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 244 DAY), @v_lee, @seed_now, @v_lee),
  (@vi_hist_29, @vr_hist_29, @campus_ct, 'VR-HIST-029-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -232 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -232 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @v_kim, DATE_SUB(@seed_now, INTERVAL 250 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 252 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_30, @vr_hist_30, @campus_qn, 'VR-HIST-030-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -240 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -240 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 260 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_31, @vr_hist_31, @campus_hn, 'VR-HIST-031-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -248 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -248 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 268 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -247 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 268 DAY), @v_nguyen_no_dau, @seed_now, @u_staff_hn),
  (@vi_hist_32, @vr_hist_32, @campus_hcm, 'VR-HIST-032-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -256 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -256 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 276 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 276 DAY), @v_lee, @seed_now, @u_staff_hcm),
  (@vi_hist_33, @vr_hist_33, @campus_dn, 'VR-HIST-033-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -264 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -264 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 284 DAY), @v_kim, @seed_now, @v_kim),
  (@vi_hist_34, @vr_hist_34, @campus_ct, 'VR-HIST-034-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -272 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -272 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 290 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 292 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_35, @vr_hist_35, @campus_qn, 'VR-HIST-035-QN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -280 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -280 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 300 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  (@vi_hist_36, @vr_hist_36, @campus_hn, 'VR-HIST-036-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -288 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -288 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 308 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 308 DAY), @v_lee, @seed_now, @u_staff_hn),
  (@vi_hist_37, @vr_hist_37, @campus_hcm, 'VR-HIST-037-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -296 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -296 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 316 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hcm, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -295 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 316 DAY), @v_kim, @seed_now, @u_staff_hcm),
  (@vi_hist_38, @vr_hist_38, @campus_dn, 'VR-HIST-038-DN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -304 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -304 DAY), INTERVAL 990 MINUTE), 'WAITING_REQUEST_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 324 DAY), @v_smith, @seed_now, @v_smith),
  (@vi_hist_39, @vr_hist_39, @campus_ct, 'VR-HIST-039-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -312 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -312 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @v_nguyen_no_dau, DATE_SUB(@seed_now, INTERVAL 330 DAY), 'VISITOR', 'SELF_SERVICE', 'Khách tự hủy trên hệ thống sau khi đơn đã được duyệt do thay đổi lịch trình công tác.', 0, DATE_SUB(@seed_now, INTERVAL 332 DAY), @v_nguyen_no_dau, @seed_now, @v_nguyen_no_dau),
  ...
  (@vi_hist_41, @vr_hist_41, @campus_hn, 'VR-HIST-041-HN', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -328 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -328 DAY), INTERVAL 990 MINUTE), 'CLOSED', @u_staff_hn, @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 348 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, @u_staff_hn, DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -327 DAY), INTERVAL 600 MINUTE), 'Đã hoàn tất hồ sơ.', NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 348 DAY), @v_kim, @seed_now, @u_staff_hn),
  (@vi_hist_42, @vr_hist_42, @campus_hcm, 'VR-HIST-042-HCM', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -336 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -336 DAY), INTERVAL 990 MINUTE), 'AFTER_VISIT', @u_staff_hcm, @u_stafflead_hcm, DATE_SUB(@seed_now, INTERVAL 356 DAY), 'MANUAL_APPROVAL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, DATE_SUB(@seed_now, INTERVAL 356 DAY), @v_smith, @seed_now, @u_staff_hcm),
  ...
  (@vi_hist_44, @vr_hist_44, @campus_ct, 'VR-HIST-044-CT', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -352 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -352 DAY), INTERVAL 990 MINUTE), 'CANCELLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 370 DAY), 'HOST', 'EXTERNAL_CONFIRMATION', 'Host hủy thay khách sau khi khách xác nhận qua email/điện thoại rằng đoàn không thể tham gia theo lịch đã duyệt.', 0, DATE_SUB(@seed_now, INTERVAL 372 DAY), @v_lee, @seed_now, @v_lee);
...
VALUES
  (NULL, @vi_as_hn, @u_staff_hn, 'IC_HOST', TRUE, 'ACCEPTED', @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 10 DAY), DATE_SUB(@seed_now, INTERVAL 9 DAY), @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 10 DAY), 'Host chính là IC Staff Hà Nội.', DATE_SUB(@seed_now, INTERVAL 10 DAY), @u_stafflead_hn, @seed_now, @u_stafflead_hn),
  (NULL, @vi_as_hn, @u_stafflead_hn, 'IC_SUPPORT', FALSE, 'ASSIGNED', @u_stafflead_hn, DATE_SUB(@seed_now, INTERVAL 2 DAY), NULL, NULL, NULL, 'Staff Leader theo dõi điều phối, không phải Host.', DATE_SUB(@seed_now, INTERVAL 2 DAY), @u_stafflead_hn, NULL, NULL),
...
VALUES
  ...
  (NULL, @vi_am_hn, 1, 'Check-in đoàn liên cơ sở', 'Đang diễn ra tại Hà Nội.', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 540 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL 0 DAY), INTERVAL 600 MINUTE), 'Sảnh Alpha', @u_staff_hn, DATE_SUB(@seed_now, INTERVAL 3 DAY), @u_staff_hn, @seed_now, @u_staff_hn),
  (NULL, @vi_av_ct, 1, 'Tổng kết sau visit Cần Thơ', 'Chờ gửi biên bản.', DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -2 DAY), INTERVAL 900 MINUTE), DATE_ADD(DATE_ADD(DATE(@seed_now), INTERVAL -2 DAY), INTERVAL 960 MINUTE), 'Phòng họp Cần Thơ 2', @u_staff_ct, DATE_SUB(@seed_now, INTERVAL 5 DAY), @u_staff_ct, @seed_now, @u_staff_ct);
...
VALUES
  (@min_draft, @vi_av_ct, 'Biên bản dự thảo sau chuyến thăm Cần Thơ', 'Nội dung đang rà soát.', JSON_ARRAY(JSON_OBJECT('name','IC Staff CT','role','Host')), 'DRAFT', NULL, NULL, DATE_SUB(@seed_now, INTERVAL 1 DAY), @u_staff_ct, @seed_now, @u_staff_ct),
  (@min_final, @vi_cl_hn, 'Biên bản chính thức đoàn nghiên cứu AI', 'Hai bên thống nhất tiếp tục trao đổi về MOU.', JSON_ARRAY(JSON_OBJECT('name','IC Staff HN','role','Host')), 'FINAL', @u_staff_hn, DATE_SUB(@seed_now, INTERVAL 28 DAY), DATE_SUB(@seed_now, INTERVAL 30 DAY), @u_staff_hn, DATE_SUB(@seed_now, INTERVAL 28 DAY), @u_staff_hn);
...
VALUES
  (NULL, @min_draft, 'Gửi email cảm ơn', 'Gửi cho đại diện đoàn khách trong ngày.', DATE_ADD(DATE(@seed_now), INTERVAL 2 DAY), 'TODO', NULL, 1, DATE_SUB(@seed_now, INTERVAL 1 DAY), @u_staff_ct, @seed_now, @u_staff_ct),
  (NULL, @min_draft, 'Gửi hình ảnh sau sự kiện', 'Chọn ảnh phù hợp trước khi gửi.', DATE_ADD(DATE(@seed_now), INTERVAL 3 DAY), 'IN_PROGRESS', NULL, 2, DATE_SUB(@seed_now, INTERVAL 1 DAY), @u_staff_ct, @seed_now, @u_staff_ct),
  (NULL, @min_final, 'Gửi MOU bản nháp', 'Gửi file MOU cho đối tác để hai bên cùng góp ý.', DATE_SUB(DATE(@seed_now), INTERVAL 25 DAY), 'DONE', DATE_SUB(@seed_now, INTERVAL 25 DAY), 1, DATE_SUB(@seed_now, INTERVAL 30 DAY), @u_staff_hn, DATE_SUB(@seed_now, INTERVAL 25 DAY), @u_staff_hn);

INSERT INTO feedbacks (feedback_id, visit_request_id, visit_instance_id, submitted_by_user_id, submitter_role, submitter_context, submitter_name_snapshot, target_user_id, target_role, target_context, target_name_snapshot, rating, comment, submitted_at)
VALUES
  (NULL, @vr_after_visit, @vi_av_ct, @v_short_name, 'VISITOR', 'Khách đại diện', 'Visitor Short Name', @u_staff_ct, 'HOST', 'Host chính', 'IC Staff Host', 4, 'Host đón tiếp chu đáo, nhưng cần gửi agenda sớm hơn.', DATE_SUB(@seed_now, INTERVAL 1 DAY)),
  (NULL, @vr_closed, @vi_cl_hn, @u_dept_it_hn, 'LOGISTICS', 'Thiết bị/phòng lab', 'Trần Văn IT', @u_staff_hn, 'HOST', 'Host chính', 'IC Staff Host', 4, 'Host phối hợp tốt, nhưng gửi thông tin setup hơi sát giờ.', DATE_SUB(@seed_now, INTERVAL 27 DAY)),
  (NULL, @vr_closed, @vi_cl_hn, @u_staff_hn, 'HOST', 'Host chính', 'IC Staff Host', @v_long_name, 'VISITOR', 'Đại diện đoàn khách', 'Visitor Long Name', 5, 'Khách đúng giờ, thiện chí và hợp tác tốt.', DATE_SUB(@seed_now, INTERVAL 27 DAY)),
  (NULL, @vr_closed, @vi_cl_hn, @u_staff_hn, 'HOST', 'Host chính', 'IC Staff Host', @u_dept_it_hn, 'LOGISTICS', 'Thiết bị/phòng lab', 'Trần Văn IT', 3, 'Thiết bị chuẩn bị đủ nhưng hoàn tất hơi muộn.', DATE_SUB(@seed_now, INTERVAL 27 DAY));
...
VALUES
  ...
  (NULL, @file_doc_minutes, 'MINUTES', @min_final, @campus_hn, 'Biên bản chính thức đoàn nghiên cứu AI', 'PDF biên bản đã chốt.', 'MINUTES', 'PUBLISHED', DATE_SUB(@seed_now, INTERVAL 28 DAY), @u_staff_hn, @seed_now, @u_staff_hn),
...
VALUES
  ...
  (@vr_approved_single_before, @vi_as_hn, 'CAMPUS_INSTANCE', 'WAITING_REQUEST_APPROVAL', 'BEFORE_VISIT', @u_staff_hn, 'Staff Leader approved and started preparation.', DATE_SUB(@seed_now, INTERVAL 12 DAY)),
  (@vr_approved_multi_during, @vi_am_hn, 'CAMPUS_INSTANCE', 'BEFORE_VISIT', 'DURING_VISIT', @u_staff_hn, 'Visit started at Hà Nội.', DATE_SUB(@seed_now, INTERVAL 1 HOUR)),
  (@vr_after_visit, @vi_av_ct, 'CAMPUS_INSTANCE', 'DURING_VISIT', 'AFTER_VISIT', @u_staff_ct, 'Visit finished, preparing minutes.', DATE_SUB(@seed_now, INTERVAL 1 DAY)),
  (@vr_closed, @vi_cl_hn, 'CAMPUS_INSTANCE', 'AFTER_VISIT', 'CLOSED', @u_staff_hn, 'Closed after minutes and feedback.', DATE_SUB(@seed_now, INTERVAL 28 DAY)),
...
VALUES
  ...
  -- Staff Leader intentionally has no UC-136 grant in this seed; cancel belongs to Visitor, current Host (Staff), or HO.
