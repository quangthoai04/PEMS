...
const newBlock = `                  </div>
                  ...
                  {matchedPartnerFromEmail && (
                    <div className="p-3 bg-indigo-50 border border-indigo-200 text-indigo-700 rounded-xl text-xs font-bold flex items-start gap-2.5 font-sans shadow-sm mt-4">
