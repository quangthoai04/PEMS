      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Desktop Nav */}
            <nav className="hidden lg:flex items-center space-x-1 font-medium text-[15px]">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    <img src={avatarImg} alt="Avatar" className="w-8 h-8 rounded-full border border-gray-200 object-cover" />
                    <span className="font-bold text-[#004c91] text-sm">{user.name}</span>
