        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2 mb-1 bg-white/60 text-slate-700 border border-slate-200/80 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider w-fit shadow-xs">
              ...
              <span>Hệ thống quản trị hợp tác quốc tế</span>
            </div>
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-1 tracking-tight text-slate-900">
              Xin chào, <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004c91] to-[#f37021]">{user.name}</span>
            </h1>
