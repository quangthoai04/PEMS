/**
 * Trang CreateNews
 * Form xuất bản một chuyên mục bản tin và bài báo điện tử mới vào hệ thống.
 */
    ...
    >
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200">
          <button 
            className="px-6 py-2.5 flex items-center gap-2 rounded-xl bg-blue-50 text-[#004c91] border border-blue-100 font-bold hover:bg-blue-100 transition-colors sm:mr-auto w-full sm:w-auto justify-center"
          >
            <Plus className="w-5 h-5" />
            Thêm bản dịch sang tiếng anh
          </button>

          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button 
              onClick={() => navigate('/dashboard/news')}
              className="flex-1 sm:flex-none px-6 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-bold hover:border-[#004c91] hover:text-[#004c91] transition-colors"
            >
              Quay lại
            </button>
            
            <button 
              className="flex-1 sm:flex-none px-8 py-2.5 text-white bg-[#f37021] rounded-xl font-bold hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
            >
              Đăng Tin
            </button>
          </div>
