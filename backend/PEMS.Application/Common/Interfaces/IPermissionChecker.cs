...
public interface IPermissionChecker
{
    ...
    Task<IReadOnlyList<UserPermissionDto>> GetPermissionsForRoleAsync(string roleId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<bool> HasPermissionAsync(string roleId, string permissionCode, string minimumLevel, CancellationToken cancellationToken = default);

    /// <summary>Returns the granted level for a permission, or null when not granted.</summary>
    Task<string?> GetPermissionLevelAsync(string roleId, string permissionCode, CancellationToken cancellationToken = default);
}
