...
public enum FilePurpose
{
    ...
    BusinessCard,
    /// <summary>
    /// A report/invoice PDF generated by the system and attached to a REPORT email. Unlike every other
    /// purpose here it is not uploaded by a person — the send generates it — but it still needs a
