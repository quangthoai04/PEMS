...
{
    // ── Authentication ────────────────────────────────────────────────────
    public const string LoginSso = "UC-010.LOGIN_SSO";
    public const string LoginCredentials = "UC-011.LOGIN_CREDENTIALS";
    ...
    public const string ViewAccountDetails = "UC-098.VIEW_ACCOUNT_DETAILS";
    public const string SearchFilterAccounts = "UC-099.SEARCH_FILTER_ACCOUNTS";
    public const string UpdateAccountRole = "UC-100.UPDATE_ACCOUNT_ROLE";

    // ── Role Management ───────────────────────────────────────────────────
    public const string ViewRoleList = "UC-117.VIEW_ROLE_LIST";
    public const string CreateRole = "UC-118.CREATE_ROLE";
