...
public sealed class UpsertGoogleTranslationConfigCommandValidator
    : AbstractValidator<UpsertGoogleTranslationConfigCommand>
{
    public UpsertGoogleTranslationConfigCommandValidator()
    {
        RuleFor(x => x.Name)
