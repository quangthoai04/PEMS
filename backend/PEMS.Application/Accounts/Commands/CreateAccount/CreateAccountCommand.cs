...
/// is honoured only in dev (DevMixed) mode — production accounts sign in via SSO/FEID.
/// </summary>
public sealed class CreateAccountCommand : IRequest<CreateAccountResponse>
{
    public string Email { get; set; } = string.Empty;
    public string FullName { get; set; } = string.Empty;
    public string RoleCode { get; set; } = string.Empty;     // ADMIN | HO | STAFF | DEPT | STUDENT | VISITOR
    ...
    /// <summary>Optional temporary password — honoured only in DevMixed mode.</summary>
