...
/// <summary>
/// Clock-driven identity-claim maintenance (plan §16.8): expires overdue PENDING claims and redacts
/// terminal claims past retention. Runs regardless of the v2 feature flags — existing v2 data must keep
...
/// </summary>
public sealed class VisitContactClaimMaintenanceHostedService : BackgroundService
{
    private readonly IServiceScopeFactory _scopeFactory;
    private readonly ILogger<VisitContactClaimMaintenanceHostedService> _logger;
    private readonly TimeSpan _pollInterval;
    private readonly int _batchSize;

    public VisitContactClaimMaintenanceHostedService(
        IServiceScopeFactory scopeFactory,
        ILogger<VisitContactClaimMaintenanceHostedService> logger,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var maintenance = scope.ServiceProvider.GetRequiredService<IVisitContactClaimMaintenanceService>();
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "visit-contact-claim maintenance sweep failed");
            }
